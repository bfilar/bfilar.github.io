...
img: assets/img/publication_preview/llm_generated_detection.png
importance: 2
...
- The graduated-trust deployment framework that determines what we *do* with the eval results: [Trust, Then Autonomy]({{ '/projects/trust_then_autonomy/' | relative_url }})
